...
history_prompt = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            "Answer questions only about SQL and databases, based on this database structure: {structure}. If the question is unrelated to SQL, prompt the user to ask an SQL-specific question.",
        ),
